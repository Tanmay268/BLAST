...
OUTPUT_PROBABILITIES = "results/data/incident_capability_probabilities.csv"
OUTPUT_MAGNITUDES = "results/data/incident_capability_magnitude.csv"
OUTPUT_CASE_MAGNITUDES = "results/data/case_capability_magnitude.csv"
...
def main():
    ...
    footprint.to_csv("results/data/incident_type_capability_footprint.csv", index=False)
    ...
    print("results/data/incident_type_capability_footprint.csv")
