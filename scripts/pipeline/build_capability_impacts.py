...
CAPABILITY_FILE = "results/data/business_capabilities.csv"

OUTPUT_IMPACTS = "results/data/capability_impacts.csv"
OUTPUT_MATRIX = "results/data/incident_capability_matrix.csv"
OUTPUT_OVERLAP = "results/data/incident_capability_overlap.csv"
