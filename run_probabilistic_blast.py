...
PROBABILITIES_FILE = "incident_capability_probabilities.csv"

OUTPUT_GREEDY = "blast_greedy_probabilistic.csv"
OUTPUT_SUBMODULARITY = "submodularity_check_probabilistic.csv"
...
def main():
    ...
    comparison.to_csv("blast_vs_baseline_probabilistic.csv", index=False)
    ...
    print("blast_vs_baseline_probabilistic.csv")
