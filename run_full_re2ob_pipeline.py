...
BASE_DIR = Path("./data")
CHECKPOINT_DIR = Path("./journey_checkpoints")
SIGNATURE_CHECKPOINT_DIR = Path("./journey_signature_checkpoints")

EXCLUDED_CASES_FILE = "excluded_cases.csv"
FINAL_OUTPUT = "journey_impairment_full.csv"
FINAL_SIGNATURE_CATALOG = "journey_signature_catalog_full.csv"
